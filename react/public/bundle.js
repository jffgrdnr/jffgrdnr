		...
		render: function render() {
			...
			return React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'col-md-4' },
					React.createElement(Modal, { modal: this.props.modal })
				)
			);
		}
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalContents = __webpack_require__(218);
	var ProfileModal = __webpack_require__(219);
	var Example = __webpack_require__(220);
	var Modal = React.createClass({
		displayName: 'Modal',

		componentDidMount: function componentDidMount() {
			var modalContents = ReactDOMServer.renderToString(React.createElement(ProfileModal, null)),
			    profileModal = ReactDOMServer.renderToString(React.createElement(ProfileModal, null));
			var modal = React.createElement(ProfileModal, null);
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					'button',
					{ className: 'ancBtn', id: 'modalExample1', type: 'button' },
					'modal'
				),
				React.createElement(
					'button',
					{ className: 'ancBtn', id: 'modalExample2', type: 'button' },
					'HTML'
				)
			);
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ModalContents = React.createClass({
		displayName: "ModalContents",

		componentDidMount: function componentDidMount() {
			console.log(React.createElement(ModalContents, null));
		...
		render: function render() {
			return React.createElement(
				...
				React.createElement(
					"button",
					{ className: "ancBtn clickMe", type: "button" },
					"hi"
				),
				React.createElement(
					"p",
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'form',
	                    { action: '#', className: 'form', encType: 'multipart/form-data', method: 'post' },
	                    React.createElement(
	                        'div',
	                        { className: 'ancGrid' },
	                        React.createElement(
	                            'div',
	                            { className: 'ancCol w100' },
	                            React.createElement(
	                                'label',
	                                { htmlFor: 'autocompleteExample1', className: 'slide' },
	                                'test'
	                            ),
	                            React.createElement('input', { id: 'autocompleteExample1', type: 'text', name: 'firstNameMale', className: 'personFirstName', placeholder: '{{#localize}}FIRST_NAME{{/localize}}',
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'div',
	                                { className: 'ancCol ancColRow w50 topSpacing' },
	                                React.createElement(
	                                    'label',
	                                    { htmlFor: 'lastNameRoot', className: 'slide' },
	                                    'test'
	                                ),
	                                React.createElement('input', { id: 'lastNameRoot', type: 'text', name: 'lastNameMale', className: 'personLastNamePaternal', placeholder: '{{#localize}}LAST_NAME{{/localize}} {{#localize}}PATERNAL{{/localize}}',
	                                    onfocus: 'this.placeholder = \'\'', onblur: 'this.placeholder = \'{{#localize}}LAST_NAME{{/localize}} {{#localize}}PATERNAL{{/localize}}\'' })
	                            ),
	                            React.createElement(
	                                'div',
	                                { className: 'ancCol w50 topSpacing' },
	                                React.createElement(
	                                    'label',
	                                    { htmlFor: 'lastNameRoot', className: 'slide' },
	                                    'test'
	                                ),
	                                React.createElement('input', { id: 'lastNameRoot', type: 'text', name: 'lastNameMale', className: 'personLastNameMaternal', placeholder: '{{#localize}}LAST_NAME{{/localize}} {{#localize}}MATERNAL{{/localize}}',
	                                    onfocus: 'this.placeholder = \'\'', onblur: 'this.placeholder = \'{{#localize}}LAST_NAME{{/localize}} {{#localize}}MATERNAL{{/localize}}\'' })
	                            )
	                        ),
	                        React.createElement(
	                            'div',
	                            { className: 'ancCol ancColRow w100' },
	                            React.createElement(
	                                'label',
	                                { htmlFor: 'birthDateAgeRoot', className: 'slide' },
	                                'test'
	                            ),
	                            React.createElement('input', { id: 'birthDateAgeRoot', type: 'text', name: 'birthDateAgeMale', className: 'personBirthDate', placeholder: '{{#localize}}BIRTH_DATE_AGE{{/localize}}',
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'label',
	                                { htmlFor: 'birthCityStateRoot', className: 'slide' },
	                                'test'
	                            ),
	                            React.createElement('input', { id: 'birthCityStateRoot', type: 'text', name: 'birthCityStateMale', className: 'personBirthLoc', placeholder: '{{#localize}}BIRTH_CITY_STATE{{/localize}}',
	                                onfocus: 'this.placeholder = \'\'', onblur: 'this.placeholder = \'{{#localize}}BIRTH_CITY_STATE{{/localize}}\'' })
	                        ),
	                        React.createElement(
	                            'div',
	                            { className: 'ancCol ancColRow w100 showDead' },
	                            React.createElement(
	                                'label',
	                                { htmlFor: 'deathDateAgeRoot', className: 'slide' },
	                                'test'
	                            ),
	                            React.createElement('input', { id: 'deathDateAgeRoot', type: 'text', name: 'deathDateAgeMale', className: 'personDeathDate', placeholder: '{{#localize}}DEATH_DATE_AGE{{/localize}}',
	                        ...
	                        React.createElement(
	                            ...
	                            React.createElement(
	                                'label',
	                                { htmlFor: 'deathCityStateRoot', className: 'slide' },
	                                'test'
	                            ),
	                            React.createElement('input', { id: 'deathCityStateRoot', type: 'text', name: 'deathCityStateMale', className: 'personDeathLoc', placeholder: '{{#localize}}DEATH_CITY_STATE{{/localize}}',
	                                onfocus: 'this.placeholder = \'\'', onblur: 'this.placeholder = \'{{#localize}}DEATH_CITY_STATE{{/localize}}\'' })
	                        ),
	                        React.createElement(
	                            'div',
	                            { className: 'ancCol ancColRow w100' },
	                            React.createElement('input', { id: 'livingDeadRoot', type: 'checkbox', className: 'checkbox livingDead' }),
	                            React.createElement(
	                                'label',
	                                { htmlFor: 'livingDeadRoot' },
	                                'test'
	                            )
	                        )
	                    ),
	                    React.createElement(
	                        'button',
	                        { type: 'submit', className: 'ancBtn lrg green savePersonAdd' },
	                        'test'
	                    )
	                )
	            )

    ...
    <div class="box-content">
      <form action="<?php echo $link; ?>" method="get" class="kuler-filter-form">
        ...
        <div class="filter-group">
          <p class="filter-group__title"><?php echo $__['text_filter_by_category']; ?></p>
          <div>
            <select name="category_id" class="form-control input-md filter-group__select">
        ...
        <div class="filter-group">
          <div>
            <p class="filter-group__title"><?php echo $__['text_filter_by_manufacturer']; ?></p>
            <select name="manufacturer_id" class="form-control input-md filter-group__select">
              <option value="0"><?php echo $__['text_all']; ?></option>
        ...
        <div class="filter-group">
          <p class="filter-group__title"><?php echo $__['text_filter_by_attributes']; ?></p>
        ...
        <div class="filter-group">
          <p class="filter-group__title"><?php echo $__['text_filter_by_options']; ?></p>
        ...
        <div>
          <p class="filter-group__title"><?php echo $__['text_price']; ?> (<?php echo $setting['currency']; ?>) <span
        ...
        <div class="buttons">
          <div class="right">
            <button type="submit" class="btn"><span><?php echo $__['text_search']; ?></span></button>
          </div>
        </div>
      </form>
    </div>

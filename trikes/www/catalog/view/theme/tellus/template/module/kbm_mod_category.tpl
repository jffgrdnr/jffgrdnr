<div id="kbm-category-<?php echo $module; ?>" class="kbm-category">
    <div class="box kuler-module">
	    <?php if ($show_title) { ?>
        <div class="box-heading kbm-category__heading dropdown-toggle" data-toggle="dropdown"><div class="kbm-category-btn"></div> <span><?php echo $title; ?></span></div>
	    <?php } ?>
        <div class="box-content horizontal dropdown-menu">
            <ul class="treemenu">

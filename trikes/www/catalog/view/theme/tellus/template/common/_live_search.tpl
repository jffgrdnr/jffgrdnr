...
$kuler->addScript('catalog/view/theme/' . $theme . '/js/live_search.js', true);
...
<div id="search" class="live-search-container">
	...
	<select name="manufacturer_id" class="kf_manufacturer form-control input-md hidden">
	...
	<?php } ?>
  <div id="search-inner">
		<input class="<?php echo $search_in_category ? 'category' : 'no-category' ?> kf_search form-control input-md" type="text" name="search" placeholder="<?php echo $kuler->translate($kuler->getSkinOption('search_field_text')); ?>" />

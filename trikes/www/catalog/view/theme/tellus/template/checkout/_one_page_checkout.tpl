  ...
  <div id="order-account" class="customer-info col-md-5">
    <div class="row">
      ...
      <fieldset class="col-xs-12">
        ...
        <div id="shipping-address-selector" style="margin: 20px 0;">
      ...
      <fieldset class="col-xs-12">
        ...
        <div id="payment-address-selector" style="margin: 20px 0;">
      ...
      <div class="col-xs-12">
        ...
        <fieldset id="password-container" class="form-horizontal">
          <div class="form-group required">
            <label class="col-sm-4 control-label" for="input-order-password"><?php echo _t('entry_password'); ?></label>

            <div class="col-sm-8"><input type="password" name="password" id="input-order-password"
                                          placeholder="<?php echo _t('entry_password'); ?>" class="form-control"/></div>
          </div>
          <div class="form-group required">
            <label class="col-sm-4 control-label" for="input-order-confirm"><?php echo _t('entry_confirm'); ?></label>
            <div class="col-sm-8"><input type="password" name="confirm" id="input-order-confirm"
                                          placeholder="<?php echo _t('entry_confirm'); ?>" class="form-control"/></div>
          </div>
          <div class="col-xs-12">
            <label>
  ...
  <div class="order-info col-md-7">
    <div class="method row">
      ...
      <div class="shipping-method col-md-6">
        <fieldset>
          <legend><?php echo _t('text_opcheckout_shipping_method'); ?></legend>
      ...
      <div class="payment-method col-md-6">
        <fieldset>
          <legend><?php echo _t('text_opcheckout_payment_method'); ?></legend>
    ...
    <div class="order-total">
      <fieldset>
        <legend><?php echo _t('text_opcheckout_confirm'); ?></legend>
        <div id="order-total-content" class="table-responsive"></div>
      </fieldset>
    </div>

    <p>
      <label><input type="checkbox" name="add_comment" value="1" class="toggle-option" data-target="#comment" /> <?php echo _t('text_comments'); ?></label><br/>
      <textarea name="comment" cols="50" rows="10" id="comment" class="form-control"></textarea>
    </p>
    <p>
      <label><input type="checkbox" value="1" class="toggle-option" data-target="#coupon-container" /> <?php echo _t('text_use_coupon'); ?></label>
      <div id="coupon-container" class="form-group">
        <label for="coupon" class="col-sm-4 control-label"><?php echo _t('entry_coupon'); ?></label>
      <input type="text" id="coupon" value="<?php echo $coupon; ?>" class="col-sm-4 form-control" />
      <button type="button" id="apply-coupon" class="btn"><span><?php echo _t('button_coupon'); ?></span></button>
      </div>
    </p>
    <p>
      <label><input type="checkbox" value="1" class="toggle-option" data-target="#voucher-container" /> <?php echo _t('text_use_voucher'); ?></label>
      <div id="voucher-container" class="form-group">
        <label for="voucher" class="col-sm-5 control-label"><?php echo _t('entry_voucher'); ?></label>
        <input type="text" id="voucher" value="<?php echo $voucher; ?>" class="col-sm-3 form-control" />
        <button type="button" id="apply-voucher" class="btn"><span><?php echo _t('button_voucher'); ?></span></button>
      </div>
    </p>
    <p>
      <label id="input-order-order-agree"><input type="checkbox" name="order_agree" value="1" /> <?php echo $text_agree; ?></label>
    </p>
    <button type="submit" id="confirm-order" class="btn pull-right"><span><?php echo _t('button_confirm'); ?></span></button>
  </div>
</form>
</div>
</div>
...
<div style="display: none;">
  <?php if (!$is_logged) { ?>
    <div id="login-popup" class="popup-container">
      <form class="form-horizontal">
        ...
        <div class="form-group">
          <a href="<?php echo $forgotten; ?>" class="col-sm-4 control-label"><?php echo _t('text_forgotten'); ?></a>
          <div class="col-sm-8">
  ...
  <div id="address-form-container" class="popup-container">
    ...
    <form id="address-form" class="form-horizontal">
      ...
      <div class="form-group required">
        <label class="col-sm-3 control-label" for="input-new-zone"><?php echo _t('entry_zone'); ?></label>
        <div class="col-sm-9">
        ...
        <?php if ($custom_field['location'] == 'address') { ?>
          <?php if ($custom_field['type'] == 'select') { ?>
            <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
              <label class="col-sm-3 control-label" for="input-new-custom-field<?php echo $custom_field['custom_field_id']; ?>"><?php echo $custom_field['name']; ?></label>
              <div class="col-sm-9">
      ...
      <div class="form-group">
        <div class="col-sm-12">
          <button type="submit" class="btn pull-right"><span><?php echo _t('button_continue'); ?></span></button>
        </div>
      </div>
    </form>
  </div>

  ...
  <div id="collapse-voucher" class="panel-collapse collapse">
    <div class="panel-body">
      ...
      <div class="input-group">
        ...
        <button type="submit" id="button-voucher" data-loading-text="<?php echo $text_loading; ?>"  class="btn"><span><?php echo $button_voucher; ?></span></button>
        </span> </div>
...
$('#button-voucher').on('click', function() {
  $.ajax({
    ...
    success: function(json) {
      ...
      if (json['error']) {
        $('#collapse-voucher').before('<div class="alert alert-danger"><i class="fa fa-exclamation-circle"></i> ' + json['error'] + '<button type="button" class="close" data-dismiss="alert"><i class="fa fa-times"></i></button></div>');
      }

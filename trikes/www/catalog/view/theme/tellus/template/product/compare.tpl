      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="rating"><?php for ($i = 1; $i <= 5; $i++) { ?>
              ...
              <?php } else { ?>
              <span class="fa fa-stack"><i class="fa fa-star"></i><i class="fa fa-star-o"></i></span>
              <?php } ?>
              <?php } ?>
              <br />
        ...
        <tr>
          ...
          <td class="text-center">
            <button type="button" class="btn" onclick="cart.add('<?php echo $product['product_id']; ?>');"><span><?php echo $button_cart; ?></span></button>
            <a href="<?php echo $product['remove']; ?>" class="btn"><span><?php echo $button_remove; ?></span></spa></a></td>
          <?php } ?>
        </tr>
      </table>
      <?php } else { ?>

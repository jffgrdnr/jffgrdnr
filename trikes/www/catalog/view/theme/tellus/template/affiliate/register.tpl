  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <h1 class="page-heading">
        ...
        <p class="account-already"><?php echo $text_account_already; ?></p>
        <p class="page-heading-description"><?php echo $text_signup; ?></p>
      </h1>
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-account">
      <div class="row">
        ...
        <div class="col-lg-6 col-md-6 col-xs-12">
          <fieldset>
            ...
            <div class="form-group">
              <label class="col-sm-3 control-label" for="input-website"><?php echo $entry_website; ?></label>
              <div class="col-sm-9">
        ...
        <div class="col-xs-12">
          <?php if ($text_agree) { ?>
            <div class="buttons">
              <label for="chkAgree">
                <?php if ($agree) { ?>
                <input type="checkbox" name="agree" value="1" checked="checked" id="chkAgree" />
                <?php } else { ?>
                <input type="checkbox" name="agree" value="1" id="chkAgree" />
                <?php } ?>
                <?php echo $text_agree; ?>
              </label>
              <button type="submit" class="btn pull-right"><span><?php echo $button_continue; ?></span></button>
            </div>
          <?php } else { ?>
          <div class="buttons">
